      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="relative z-1 max-w-[16rem] ml-auto">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div
              className="relative min-h-[39rem] border-n-1/10 
            ...
            <div
              className="p-4 bg-n-7 
            rounded-3xl overflow-hidden lg:min-h-[46rem]"
            >
